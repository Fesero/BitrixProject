...
$APPLICATION->SetPageProperty('bf_page_class', trim($currentPageClass . ' bf-detail'));
...
?>
<div class="bf-detail-shell bx-<?=$arParams['TEMPLATE_THEME']?>">
	<div class="bf-detail-shell__main">
		<?php
